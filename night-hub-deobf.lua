    ...
    while wait() do
        if _G.AutoKatakuri then
            pcall(function()
                ...
                local map = game:GetService("Workspace").Map.CakeLoaf.BigMirror.Other
                    ...
                    for i, v in pairs(enemies:GetChildren()) do
                        if v.Name == "Cake Prince" or v.Name == "Dough King" then
                            if v.Humanoid.Health > 0 and (v:FindFirstChild("HumanoidRootPart") or v.Parent or _G.AutoKatakuri) then
                                ...
                                until v.Humanoid.Health <= 0 or not v.Parent or not v:FindFirstChild("HumanoidRootPart") or map.Transparency == 1
                            end
                        end
                    end
                else
                    if replicatedStorage:FindFirstChild("Cake Prince") then
                        Tween(replicatedStorage:FindFirstChild("Cake Prince").HumanoidRootPart.CFrame * CFrame.new(20, -50, 20))
                    elseif replicatedStorage:FindFirstChild("Dough King") then
                        Tween(replicatedStorage:FindFirstChild("Dough King").HumanoidRootPart.CFrame * CFrame.new(20, -50, 20))
                    else
                        if map.Transparency == 1 then
                            if enemies:FindFirstChild("Cookie Crafter") or enemies:FindFirstChild("Cake Guard") or enemies:FindFirstChild("Baking Staff") or enemies:FindFirstChild("Head Baker") then
                                for i, v in pairs(enemies:GetChildren()) do
                                    if v.Name == "Cookie Crafter" or v.Name == "Cake Guard" or v.Name == "Baking Staff" or v.Name == "Head Baker" then
                                        if v.Humanoid.Health > 0 and (v:FindFirstChild("HumanoidRootPart") or v.Parent or _G.AutoKatakuri) then
                                            ...
                                            until v.Humanoid.Health <= 0 or not v.Parent or not v:FindFirstChild("HumanoidRootPart") or map.Transparency == 0
                                        end
                                    end
                                end
                            else
                                if BypassTP then
                                    if (localCharacter.HumanoidRootPart.Position - PosCake.Position).Magnitude > 2000 then
                                        BP(PosCake)
                                    elseif (localCharacter.HumanoidRootPart.Position - PosCake.Position).Magnitude < 2000 then
                                        Tween(PosCake)
                                    end
                                else
                                    Tween(PosCake)
                                ...
                                MagnetDought = false
                                if replicatedStorage:FindFirstChild("Cookie Crafter") then
                                    Tween(replicatedStorage:FindFirstChild("Cookie Crafter").HumanoidRootPart.CFrame * CFrame.new(2, 20, 2)) 
                                elseif replicatedStorage:FindFirstChild("Cake Guard") then
                                    Tween(replicatedStorage:FindFirstChild("Cake Guard").HumanoidRootPart.CFrame * CFrame.new(2, 20, 2)) 
                                elseif replicatedStorage:FindFirstChild("Baking Staff") then
                                    Tween(replicatedStorage:FindFirstChild("Baking Staff").HumanoidRootPart.CFrame * CFrame.new(2, 20, 2))
                                elseif replicatedStorage:FindFirstChild("Head Baker") then
                                    Tween(replicatedStorage:FindFirstChild("Head Baker").HumanoidRootPart.CFrame * CFrame.new(2, 20, 2))
                                end
                            end
                        else
                            if replicatedStorage:FindFirstChild("Cake Prince") then
                                Tween(replicatedStorage:FindFirstChild("Cake Prince").HumanoidRootPart.CFrame * CFrame.new(20, 40, 20))
                            elseif replicatedStorage:FindFirstChild("Dough King") then
                                Tween(replicatedStorage:FindFirstChild("Dough King").HumanoidRootPart.CFrame * CFrame.new(20, 40, 20))
                            end
                        end
                    end
                end
