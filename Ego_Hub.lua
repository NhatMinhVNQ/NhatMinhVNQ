...
local Window = OrionLib:MakeWindow({Name = "Ego Hub", HidePremium = false,
IntroText = " EGO HUB", SaveConfig = true, ConfigFolder = "Ego Hub"})
...
OrionLib:MakeNotification({
	Name = "Ego Hub",
	Content = "Ego Hub Not Skidder, Please don't says",
	Image = "rbxassetid://4483345998",
	Time = 25
})
